...
print("leverage bonds =",return1.iloc[:,0:4])
adjust_return = return1.iloc[:,0:4] * n_leverage
adjust_return = pd.concat([adjust_return,return1.iloc[:,4:13]],axis=1) #after added leverage for bond
...
'''
#------------------------------------------------------------------------------------------------
test_cov = cov*250 #annual cov
test_weight = risk_parity(0.4,test_cov)
test_rc = cal_risk_contribution(test_weight, test_cov)
print('test_weight =', test_weight)
print('test_rc =',test_rc)
#------------------------------------------------------------------------------------------------
'''
